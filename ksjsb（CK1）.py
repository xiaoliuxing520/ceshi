...
# 变量名ksjsbCookie1 多个用@或换行分割，需要完整cookies，青龙单容器快手完整cookies只能放63个。建议启用60个,否则会报错
# 变量名ksjsb_code为助力码
...
if __name__ == '__main__':
    ...
    # 获取环境变量
    try:
        _Cookie = os.environ["ksjsbCookie1"]
    except:
        _Cookie = ''
    try:
        help_code = os.environ['ksjsb_code']
    except :
        help_code = '2786504784089457'
    assets = {}
    ...
    if _Cookie != '':
        ...
        print("未找到快手CK,请检查变量名是否为ksjsbCookie1！")
